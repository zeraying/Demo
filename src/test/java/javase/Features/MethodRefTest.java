...
/**
 * @author pzy
 * @create 2023-09-29-10:37
 * @function 方法引用的使用
 * 1.当要传递给Lambda体的操作，已经有了实现的方法，可以使用方法引用
 * 2.方法引用本质上是Lambda表达式，Lambda表达式作为函数式接口的实例，
 * 所以方法引用也是函数式接口的实例。
 * 3.使用格式：类(对象) :: 方法名
 * 对象 :: 非静态方法
 * 类 :: 静态方法
 * 类 :: 非静态方法
 * 4.方法引用使用的要求：要求接口中的抽象方法的形参列表和返回值类型与方法引用的方法的形参列表
 * 和返回值类型相同。
 */
...
//    String中的int t1.compareTo(t2)
    ...
    public void test5(){
        ...
        System.out.println(com1.compare("abc", "abcd"));
        System.out.println("*******************");
...
//    Employee中的String getName();
    ...
    public void test7(){
        ...
        System.out.println("*******************");
        Function<person,String> func2 = javase.IO.person::getName;
